...
String getAudioURLByVerse(int surahNumber, int verseNumber, reciterIdentifier) {
  ...
  if (reciterIdentifier == "ar.yasseraldosari") {
    String surah = surahNumber.toString().padLeft(3, '0');
    String verse = verseNumber.toString().padLeft(3, '0');
    return "https://everyayah.com/data/Yasser_Ad-Dussary_128kbps/$surah$verse.mp3";
  }
