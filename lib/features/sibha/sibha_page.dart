...
import 'package:al_munir/features/sibha/models/tasbeh.dart';
import 'package:al_munir/features/sibha/widgets/add_tasbeeh_dialog.dart';
    ...
    return Container(
      decoration: const BoxDecoration(
          ...
          image: DecorationImage(
              image: AssetImage(
                "assets/images1/tasbeehbackground.webp",
              ),
              opacity: .03,
              fit: BoxFit.cover)),
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "sibha".tr(),
            style:
                const TextStyle(fontFamily: 'cairo', color: Color(0xffe0cb8a)),
          ),
          centerTitle: true,
        ),
        body: Column(
