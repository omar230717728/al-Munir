...
import 'package:al_munir/features/quran/data/translation/get_translation_data.dart';
                                                ...
                                                if (isDownloading !=
                                                  ...
                                                  if (File("${appDir!.path}/${translationDataList[i].typeText}.json")
                                                    ...
                                                    try {
                                                      ...
                                                      // Requires fluttertoast or similar, assume usage from context or import if available
                                                      // Using similar pattern to other files if possible, or just print for now to prevent crash
                                                    }
                                                  }
                                                  setState(() {});
                                                }
