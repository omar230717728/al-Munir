...
// import 'package:al_munir/features/QuranPages/helpers/quran_audio_helper.dart';
import 'package:al_munir/features/quran/data/quran_data_source.dart';
import 'package:al_munir/features/quran/widgets/details_page/share_ayah_dialog.dart';
...
// bool _isDownloading = false;
  ...
  Widget build(BuildContext context) {
    ...
    // It has `import 'package:al_munir/blocs/player_bloc/player_bloc.dart';`?
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                "${"surah".tr()} ${context.locale.languageCode == "ar" ? quran.getSurahNameArabic(widget.surahNumber) : quran.getSurahNameEnglish(widget.surahNumber)} - ${"ayah".tr()} ${widget.verseNumber}",
                style: TextStyle(
                        ...
                        items: reciters.map((reciter) {
                          return DropdownMenuItem<int>(
                            ...
                            child: ConstrainedBox(
                              // constrain width of dropdown items
