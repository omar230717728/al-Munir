...
import 'package:al_munir/features/quran/views/quran_details_screen.dart';
import 'package:al_munir/features/widgets/hizb_quarter_circle.dart';
import 'package:al_munir/models/surah.dart';
...
import '../data/convertNumberToAr.dart';
import 'package:string_validator/string_validator.dart';

// Top-level function for compute
List<dynamic> _decodeBookmarks(dynamic jsonString) {
...
class _SurahListPageState extends State<SurahListPage> {
  ...
  void initState() {
    getStarredVerse();
    var lastRead = getValue("lastRead");
    if (lastRead != "non" &&
        lastRead is int &&
        lastRead >= 1 &&
        lastRead <= 604) {
  ...
  fetchBookmarks() async {
    final bookmarksString = getValue("bookmarks");
    if (bookmarksString != null && bookmarksString.isNotEmpty) {
      bookmarks = await compute(_decodeBookmarks, bookmarksString);
      if (mounted) setState(() {});
    }
  }
      ...
      child: KeyboardDismissOnTap(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              //     image: AssetImage("assets/images1/homebackground.webp"),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "${"surah".tr()} ${context.locale.languageCode == "ar" ? quran.getSurahNameArabic(int.parse(bookmarks[i]["suraNumber"].toString())) : quran.getSurahNameEnglish(int.parse(bookmarks[i]["suraNumber"].toString()))} - ${"ayah".tr()} ${bookmarks[i]["verseNumber"]}",
                                                    style: TextStyle(
                                                        fontFamily: "cairo",
                                                        fontSize: 14.sp,
                                                        color: getValue(
...
//                               }, icon: const Icon(Icons.remove,color:Colors.redAccent))
              ...
              appBar: PreferredSize(
                ...
                child: AppBar(
                  ...
                  actions: [
                    if (getValue("savedPageBookmark") != null &&
                        int.tryParse(getValue("savedPageBookmark").toString()) != -1)
                      Padding(
                        padding: EdgeInsets.symmetric(
                            horizontal: 4.0.w, vertical: 8.h),
                        child: IconButton(
                          onPressed: () async {
                            final page = getValue("savedPageBookmark");
                            await Navigator.push(
                                context,
                                CupertinoPageRoute(
                                    builder: (builder) => BlocProvider(
                  ...
                  bottom: PreferredSize(
                    ...
                    child: Container(
                      ...
                      child: TabBar(
                        ...
                        indicatorColor: const Color(0xffe0cb8a),
                        indicatorWeight: 4,
                        labelColor: const Color(0xffe0cb8a),
                      ...
                      child: Column(
                        children: [
                          if (getValue("lastRead") != "non" &&
                              getValue("lastRead") is int &&
                              getValue("lastRead") >= 1 &&
                              getValue("lastRead") <= 604)
                            Padding(
                                                  ...
                                                  decoration:
                                                      const BoxDecoration(
                                                          image:
                                                              DecorationImage(
                                                    image: AssetImage(
                                                      "assets/images1/sura_frame.webp",
                                                    ),
                                                  )),
                                                  child: Center(
                                                    child: Text(
