...
import 'package:al_munir/features/allah_names/data/allah_names.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "asmaa".tr(),
          style: const TextStyle(fontFamily: 'cairo', color: Color(0xffe0cb8a)),
        ),
        centerTitle: true,
      ),
      body: Container(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                                image: AssetImage(
                                    "assets/images1/nameborder.webp"))),
                        child: Center(
                          child: Text(
