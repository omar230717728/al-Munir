...
const List primaryColors = [
  Colors.black,
  Colors.white, // Fixed: Was Color(0xff283618)
  accentColor,
  Colors.black,
  Color(0XFf4C76BA),
  Color(0xff283618), // Fixed: Was Colors.white
  Color(0xffBFAE99),
...
const List backgroundColors = [
  Color(0xffFEEED4), // Was Index 13 (New 1st)
  Color(0xff22303C), // Was Index 5 (New 2nd - Dark Mode)
  Color(0xffFFFCE7),
  Colors.white,
  Colors.white,
  Color(0xfffefae0), // Was Index 1 (Swapped with 5)
  Color(0xff213440),
  Color(0xff6d6d6d),
  Color(0xff4e4c4f),
  Color(0xfff3f6f4),
  ...
  Color(0xffE7F7FE),
  Color(0xffF4FDD3),
  Color.fromARGB(255, 255, 248, 240), // Was Index 0 (Swapped with 13)
  Color(0xffD2F4CF),
  Color(0xffFEFADF),
  Color(0xffEAF0FE)
];
const List secondaryColors = [
  Color.fromARGB(255, 58, 45, 23), // Was Index 13 (New 1st)
  Color.fromARGB(255, 23, 147, 255), // Was Index 5 (New 2nd - Dark Mode)
  Color.fromARGB(255, 189, 139, 2),
  Color.fromARGB(255, 43, 43, 43),
  Color.fromARGB(255, 0, 95, 184),
  Color(0xff606c38), // Was Index 1 (Swapped with 5)
  ...
  Color(0xff946735), // Was Index 0 (Swapped with 13)
  Color.fromARGB(255, 31, 46, 29),
  Color.fromARGB(255, 36, 34, 22),
  Color.fromARGB(255, 24, 29, 43)
];
const List highlightColors = [
  Color.fromARGB(255, 255, 244, 157), // Was Index 13 (New 1st)
  Color.fromARGB(255, 120, 192, 255), // Was Index 5 (New 2nd - Dark Mode)
  Color.fromARGB(255, 255, 244, 157),
  Color.fromARGB(255, 89, 216, 255),
  Color.fromARGB(255, 89, 216, 255),
  Color.fromARGB(96, 188, 107, 37), // Was Index 1 (Swapped with 5)
  Color.fromARGB(255, 255, 244, 157),
  Color.fromARGB(255, 255, 244, 157),
  Color.fromARGB(255, 255, 244, 157),
  ...
  Color.fromARGB(255, 120, 192, 255),
  Color.fromARGB(255, 120, 192, 255),
  Color.fromARGB(172, 255, 201, 54), // Was Index 0 (Swapped with 13)
  Color.fromARGB(255, 120, 192, 255),
  Color.fromARGB(255, 120, 192, 255),
  Color.fromARGB(255, 120, 192, 255),
];
