...
// import 'package:al_munir/Core/home.dart';r
      ...
      if (event is StartPlaying) {
        ...
        try {
          ...
          Fluttertoast.showToast(
              msg: "Failed to play audio. Please check connection.");
          // print(stackTrace);
        }
        audioPlayer!.play();
        ...
        if (File(fullSuraFilePath).existsSync()) {
          ...
          try {
            await apiClient.download(event.url, fullSuraFilePath);
          } catch (e) {
            print(e);
            Fluttertoast.showToast(
                msg: "Download failed. Please check connection.");
          } // updateValue(
          //     "downloadedSurahs",
        ...
        for (var suraLink in reciterLinks) {
          ...
          if (File(fullSuraFilePath).existsSync()) {
            ...
            try {
              await apiClient.download(suraLink["link"], fullSuraFilePath);
            } catch (e) {
              print(e);
              Fluttertoast.showToast(
                  msg: "Failed to download surah. Please check connection.");
            }
          }
        }
